...
from RagBasedStockAnalyser.equity.fetch.QueryWithIDF import TranscriptQueryWithIDF,ReportQueryWithIDF
...
class TestQueryWithIDF(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.query_with_idf = TranscriptQueryWithIDF(cls.vector_store)
